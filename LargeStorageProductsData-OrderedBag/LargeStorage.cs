...
class Program
{
    static OrderedBag<Article> orderedBagOfProducts;
    ...
    {
        var result = orderedBagOfProducts.Range(new Article("searchItem", lower, "1", "2"), true, new Article("searchItem", upper, "1", "2"), true);
    ...
    {
        orderedBagOfProducts.Add(new Article(product, price, vendor, barcode));
    }
    ...
    private static void FillingTheBag()
    {
        ...
        orderedBagOfProducts = new OrderedBag<Article>();
